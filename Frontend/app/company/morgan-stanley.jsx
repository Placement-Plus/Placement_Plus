...
import companyLogo from "@/assets/companyImages/morganStanley.jpg";
...
const CodingProblems = () => {
    ...
    const getProblem = async () => {
        ...
        try {
            ...
            const response = await fetch(`http://${process.env.EXPO_PUBLIC_IP_ADDRESS}:5000/api/v1/questions/get-company-questions/c/Morgan Stanley`, {
                method: 'GET',
                headers: {
