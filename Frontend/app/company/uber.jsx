...
import companyLogo from "@/assets/companyImages/uber.png";
import companyLogoWhite from "@/assets/companyImages/uber-white-without-back.png";
...
const CodingProblems = () => {
  ...
  const getProblem = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://${process.env.EXPO_PUBLIC_IP_ADDRESS}:5000/api/v1/questions/get-company-questions/c/Uber`, {
        method: 'GET',
        headers: {
